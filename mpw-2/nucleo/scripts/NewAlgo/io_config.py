...
def run_test(test, chain):
    ...
    for i in range(0,end_pulses):
        ...
        #print("Sync pulse count :{}".format(pulse_count))
        if pulse_count == 2:
            if chain == "low":
                channel = channel + 1
            else:
            ...
            while 1:
                ...
                if val != state:
                    io_pulse = io_pulse + 1
                    #print("Channel {}->".format(channel), "io_pulse :{}->".format(io_pulse),"Current State:{}->".format(val),"Prev State:{}".format(state))
                    state = val
                if io_pulse == 8:
                    io_pulse = 0
...
def run():
    ...
    print("===================================================================")
    print("GPIO Low Channel Status : {}".format(gpio_l.channel_status))
    print("GPIO High Channel Status : {}".format(gpio_h.channel_status))
    print(" ")
